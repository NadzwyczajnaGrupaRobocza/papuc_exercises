...
int main()
{
    ...
    while(isRunning)
    {
        ...
        {
        case 'r':
            userMoves[currentMove] = RPS::Move::rock;
            break;
        case 'p':
            userMoves[currentMove] = RPS::Move::paper;
            break;
        case 's':
            userMoves[currentMove] = RPS::Move::scissors;
            break;
        case 'q':
            isRunning = false;
            continue;
        ...
        std::cout << "You play: " << userMoves[currentMove] << ", beast plays: " << rngMoves[currentMove] << ". ";
        switch (RPS::getMatchResult(userMoves[currentMove], rngMoves[currentMove]))
        {
        case RPS::MatchResult::tie:
            std::cout << "There is a stalemate between you and the beast. Fight on, noble warrior.\n";
            break;
        case RPS::MatchResult::lhsWins:
            std::cout << "You have won this skirmish, noble knight!\n";
            break;
        case RPS::MatchResult::rhsWins:
            std::cout << "The beast won this time, but there may still be hope...\n";
            break;
        }
