...
Gesture uint2Gesture(unsigned source)
{
    ...
    {
        case static_cast<int>(Gesture::Paper):
            output = Gesture::Paper;
            break;
        case static_cast<int>(Gesture::Scissors):
            output = Gesture::Scissors;
            break;
        case static_cast<int>(Gesture::Rock):
            output = Gesture::Rock;
            break;
        default:
            output = Gesture::Error;
            break;
    }
    return output;
}
...
void Game::playOneRound(const Player& player,
