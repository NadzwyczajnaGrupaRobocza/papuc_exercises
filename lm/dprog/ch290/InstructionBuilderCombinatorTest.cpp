...
TEST(InstructionBuilderCombinatorTest,
     willParseMultilineInputWithEmptyLines)
{
    std::stringstream in{" ld a,10\n ld a,255\n\n\n out (0),a\n"};
    ltm::InstructionBuilderCombinator lexer;
    const auto instructionVector = lexer.process(in);
    const auto expectedInstructionVector = std::vector<Instruction>{
        {OperationType::load, Register::reg_a, u8_t{10}, Register::INVALID},
        {OperationType::load, Register::reg_a, u8_t{255},
         Register::INVALID},
        {OperationType::output, Register::out_0, u8_t{0u},
         Register::reg_a}};
...
TEST(InstructionBuilderCombinatorTest, willParseMultilineInputWithJump)
{
    ...
    const auto expectedInstructionVector = std::vector<Instruction>{
        ...
        {OperationType::decrementAndJump, Register::reg_b, u8_t{2},
         Register::INVALID}};
...
TEST(InstructionBuilderCombinatorTest,
     willParseMultilineInputAllExistingInstructions)
{
    std::stringstream in{"begin:\n"
                         " ld a,10\n"
                         " ld a,255\n\n\n"
    ...
    const auto expectedInstructionVector = std::vector<Instruction>{
        ...
        {OperationType::load, Register::reg_a, u8_t{255},
         Register::INVALID},
        {OperationType::rotateLeftCyclic, Register::reg_a, u8_t{0},
         Register::INVALID},
        {OperationType::rotateRightCyclic, Register::reg_b, u8_t{0},
         Register::INVALID},
        {OperationType::output, Register::out_0, u8_t{0u}, Register::reg_a},
        {OperationType::decrementAndJump, Register::reg_b, u8_t{2},
         Register::INVALID}};
